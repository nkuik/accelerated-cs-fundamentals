...
static void treeFactory(GenericTree<int>& tree) {
  ...
  auto rootRightChild = root->addChild(8);
  auto rootLeftChild = root->addChild(15);
  auto thirdRight = rootRightChild->addChild(16);
  thirdRight->addChild(42);
  rootRightChild->addChild(23);
}
