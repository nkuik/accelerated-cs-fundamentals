...
void DisjointSets::dsunion(int i, int j) {
  ...
  // std::cout << "root_i is: " << root_i << std::endl;
  // std::cout << "root_j is: " << root_j << std::endl;
  
  // std::cout << "i_had_cycle is: " << i_had_cycle << std::endl;
  // std::cout << "j_had_cycle is: " << j_had_cycle << std::endl;
  if (i_had_cycle) {
    has_cycle[j] = 1;
  }
